...
// module
exports.push([module.i, "html{overflow-x:hidden}body{width:100%;min-height:100%}body::-webkit-scrollbar{width:4px}body::-webkit-scrollbar-track{background-color:#fff}body::-webkit-scrollbar-thumb{border-radius:10px;background-color:#999}code,pre{font-family:Source Pro,Helvetica,Sans-serif,San Francisco,Microsoft Yahei,SimHei}pre{background:#f6f8fa;border-radius:4px;padding:10px;overflow:auto;font-size:85%}input::-moz-placeholder{color:#ccc}input::-webkit-input-placeholder{color:#ccc}.modal-enter-active,.modal-leave-active{-webkit-transition:opacity .3s ease,-webkit-transform .3s linear;transition:opacity .3s ease,-webkit-transform .3s linear;transition:opacity .3s ease,transform .3s linear;transition:opacity .3s ease,transform .3s linear,-webkit-transform .3s linear}.modal-leave-active{opacity:0;-webkit-transform:scale(0);transform:scale(0)}.pr{position:relative}.block{display:block}.btn,.inlinetop{display:inline-block;vertical-align:top}.btn_wrap{line-height:34px}.btn{height:34px;padding:0 10px;border-radius:5px;text-align:center;color:#fff;overflow:hidden;background:#ff8a00;-webkit-transition-duration:.2s;transition-duration:.2s;cursor:pointer}.btn,.btn:hover{text-decoration:none}.btn:hover{background:#ef8100}.btn.cancel{background:#999}.btn.cancel:hover{background:#8c8c8c}.btn.disable{background:#ccc;cursor:not-allowed}.margin10{margin:10px}.paddingB50{padding-bottom:50px}.slide-left-enter,.slide-left-leave-active,.slide-right-enter,.slide-right-leave-active{opacity:0;-webkit-transition-duration:.3s;transition-duration:.3s;position:absolute;top:0;left:0}.slide-left-enter,.slide-right-leave-active{-webkit-transform:translate(-100%);transform:translate(-100%)}.slide-left-leave-active,.slide-right-enter{-webkit-transform:translate(100%);transform:translate(100%)}header{width:100%;background:#5f9ea0;margin-bottom:20px}.content{width:1200px;margin:0 auto;position:relative}.h1{font-size:32px;text-align:center;padding:10px}.nav_tree{width:125px;position:absolute;top:0;left:0;line-height:32px}.nav_tree a{display:block;font-size:16px;text-decoration:none;border-left:6px solid #ccc;padding-left:10px;margin-top:10px;height:30px;line-height:30px;background:#f6f8fa}.nav_tree a.router-link-active{border-left-color:#008b8b}.pages{padding-left:140px}.pages h2{margin:20px;color:#008b8b;font-weight:700}.pages h3{border-left:6px solid #008b8b;padding-left:6px;margin-bottom:10px;height:34px;line-height:34px;background:#eee}", ""]);
...
// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.4@babel-loader/lib!./node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=script&index=0!./src/examples.vue
...
// CONCATENATED MODULE: ./node_modules/_vue-loader@13.7.1@vue-loader/lib/template-compiler?{"id":"data-v-f3f87dc6","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/_vue-loader@13.7.1@vue-loader/lib/template-compiler/preprocessor.js?engine=pug!./node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=template&index=0!./src/examples.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app_contain"},[_vm._m(0),_c('div',{staticClass:"content"},[_c('div',{staticClass:"nav_tree"},[_c('router-link',{attrs:{"to":"./examples.html"}},[_vm._v("Before Use")]),_c('router-link',{attrs:{"to":"./loading.html"}},[_vm._v("loading / toast")]),_c('router-link',{attrs:{"to":"./alert.html"}},[_vm._v("alert / confirm")])],1),_c('transition',{attrs:{"name":_vm.transitionName}},[_c('router-view')],1)],1)])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('header',[_c('h1',{staticClass:"h1"},[_vm._v("examples for vue-kdialog")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var selectortype_template_index_0_src_examples = (esExports);
// CONCATENATED MODULE: ./src/examples.vue
function injectStyle (ssrContext) {
  __webpack_require__("x8k3")
}
...
var Component = normalizeComponent(
  examples,
  selectortype_template_index_0_src_examples,
...
/* harmony default export */ var src_examples = (Component.exports);
    ...
    methods: {
        ...
        close: function close() {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    var leftDOM = document.getElementById('kDialog_' + vm.id);
                    if (leftDOM) {
...
/* template functional */
var keydialog___vue_template_functional__ = false
/* styles */
var keydialog___vue_styles__ = null
/* scopeId */
var keydialog___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var keydialog___vue_module_identifier__ = null
var keydialog_Component = keydialog_normalizeComponent(
  keydialog,
  selectortype_template_index_0_src_keydialog,
  keydialog___vue_template_functional__,
  keydialog___vue_styles__,
  keydialog___vue_scopeId__,
  keydialog___vue_module_identifier__
)

/* harmony default export */ var src_keydialog = (keydialog_Component.exports);
...
const KeyDialogConstructor = vue_runtime_esm["a" /* default */].extend(src_keydialog);
...
/* harmony default export */ var src_keydialog_0 = ({
    install: () => {
        vue_runtime_esm["a" /* default */].prototype.$toast = keyDialog.toast; // 将 keyDialog 组件挂载在Vue的原型上
        vue_runtime_esm["a" /* default */].prototype.$alert = keyDialog.alert;
        vue_runtime_esm["a" /* default */].prototype.$loading = keyDialog.loading;
        vue_runtime_esm["a" /* default */].prototype.$confirm = keyDialog.confirm;
    },
    setRunTime(runtime) {
    ...
    eventbus() {
        ...
        Object.defineProperties(vue_runtime_esm["a" /* default */].prototype, {
            $bus: {
                get() {
                    return EventBus;
                }
...
// EXTERNAL MODULE: ./src/keydialog_pc.css
var keydialog_pc = __webpack_require__("3rOz");
var keydialog_pc_default = /*#__PURE__*/__webpack_require__.n(keydialog_pc);

// CONCATENATED MODULE: ./src/examples.js
/**
...
vue_runtime_esm["a" /* default */].config.devtools = true; // 开启浏览器 devtools 调试

const beforeuse = () => __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, "631B"));
const loading = () => __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, "KgXo"));
const examples_alert = () => __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, "fSq5"));
...
vue_runtime_esm["a" /* default */].use(src_keydialog_0);

src_keydialog_0.eventbus();

new vue_runtime_esm["a" /* default */]({
    router,
    render: h => h(src_examples),
}).$mount('#app');
...
// load the styles
var content = __webpack_require__("9W5u");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("FIqI")("c7c11a30", content, true, {});
